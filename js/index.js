	...
	var career_list = [
		{
			...
			sections:[
				...
				},
				{
					...
					projects:[
						{
						  project_name: '仿制药立项与数字营销 | 数据驱动',
						  project_discription: [
						    {
						      '项目背景': '公司需突破传统贸易模式，通过数据驱动的“立项-推广-获客”闭环，在高竞争仿制药中间体赛道中快速锁定高附加值产品并转化为订单。'
						    },
						    {
						      '项目目标': '整合开源药政数据、海关情报及流行病学指标，建立量化立项模型；同步独立站SEO+B2B矩阵，实现“选好品-内容获客-线索转化”全链路线上化。'
						    },
						    {
						      '个人行动': '1. 用Python自动抓取openFDA、PubChem等数据库和接口，结合海关数据与流行病分析，构建新药跟踪与选品模型；<br>2. 基于Reaxys&药渡绘制ROS，筛选合成壁垒高、高价值的中间体；<br>3. 在独立站做SEO，撰写疾病教育+合成+药物市场软文；<br>4. 部署GA+Hotjar追踪访客行为。'
						    },
						    {
						      '项目结果': '1. 累计立项16条API&中间体管线；<br>2. 以某HIV/AIDS药物为例，从近百个化合物中锁定10余个关键中间体，约一个季度内将CAS No.等关键词做到谷歌首页；<br>3. 通过访客行为识别出阿根廷药企A，销售跟进后成功开发客户；<br>4.辅助业务部门向战略合作供应商法人宣讲此项目，间接促成公司入股'
						    }
						  ]
						},
						{
